...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>/materia/update/<?= $materia['id_materia'] ?>">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="codigo" class="form-label">Código <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="codigo" name="codigo" 
                           value="<?= htmlspecialchars($materia['codigo']) ?>" required>
                </div>
            ...
            <div class="row">
                    ...
                    <select class="form-select" id="id_programa" name="id_programa">
                        ...
                        <?php foreach ($programas as $p): ?>
                            <option value="<?= $p['id_programa'] ?>" 
                                <?= $materia['id_programa'] == $p['id_programa'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" class="form-control" id="creditos" name="creditos" 
                           value="<?= $materia['creditos'] ?>" min="0" max="20">
                </div>
